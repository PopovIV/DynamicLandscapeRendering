...
bool UserInterface::Initialize(D3DClass* Direct3D, int screenHeight, int screenWidth) {
    ...
    result = m_Font1->Initialize(Direct3D->GetDevice(), Direct3D->GetDeviceContext(), (char*) "data/font/font01.txt", (char*)"data/font/font01.tga", 32.0f, 3);
    if (!result)
        return false;
...
// Render function
bool UserInterface::Render(D3DClass* Direct3D, ShaderManager* ShaderManager, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX orthoMatrix) {
